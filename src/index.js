    ...
    <Fragment>
        ...
        <section className="section" id="splash">
            <section id="about-wrapper" className="main-column">
                <section id="about">
                    <Typewriter className="header" prefix={"Hi, I'm "} loop={false} words={[
                        "Joey Van Lierop.",
                        "a developer.",
                        "a student.",
                        "a skiier.",
                    ...
                    <div>
                        ...
                        <Button variant="outline-dark" href="#skills">Skills</Button>
        ...
        <section className="section" id="skills">
            <h1 className="main-column header">
                Skills
                <Button variant="outline-dark" href="#" className="resume-download">Résumé</Button>
            </h1>
